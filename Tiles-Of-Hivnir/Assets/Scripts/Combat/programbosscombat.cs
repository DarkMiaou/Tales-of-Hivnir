...
namespace TalesofHivnir
{
    ...
    public class programbosscombat : PlayerCombat
    {
        ...
        private void Update()
        {
            ...
            if (timer <= 0f || isInterpreting)
            {
                ...
                timer = 60f;
                if (mobcurrenthealth < mobhealth / 2)
                {
                    if (Math.Abs(coordy) >= 3 || Math.Abs(coordx) >= 3)
                    {
                        mobanim.SetFloat("Horizontal", 0.1f);
                        mobanim.SetFloat("Vertical", 0.1f);
                        Health();
                    }
                    else if (Math.Abs(coordy) >= 2 || Math.Abs(coordx) >= 2)
                    {
                        mobanim.SetFloat("Horizontal", 0.3f);
                        mobanim.SetFloat("Vertical", 0.3f);
                        Distance();
                    }
                ...
                else
                {
                    ...
                    if (Math.Abs(coordy) <= 1 && Math.Abs(coordx) >= 0 && Math.Abs(coordx) <= 1 &&
                        Math.Abs(coordx) >= 0)
                    {
                        mobanim.SetFloat("Horizontal", 0);
                        mobanim.SetFloat("Vertical", 0);
        ...
        {
            SaveData.instance.currenthealth -= 15;
            GotDamage();
